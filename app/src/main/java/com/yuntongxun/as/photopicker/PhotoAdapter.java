...
import com.yuntongxun.as.photopicker.model.Photo;
import com.yuntongxun.as.photopicker.utils.PhotoUtils;
import com.yuntongxun.as.photopicker.widgets.SquareImageView;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
			...
			//Glide.with(mContext).load(photo.getPath()).dontAnimate().thumbnail(0.1f).into(holder.photoImageView);
        }
        return convertView;
    }
