...
import com.yuntongxun.as.common.utils.EmoticonUtil;
import com.yuntongxun.as.common.utils.FileAccessor;
import com.yuntongxun.as.common.utils.FileUtils;
import com.yuntongxun.as.common.utils.LogUtil;
import com.yuntongxun.as.common.utils.MediaPlayTools;
import com.yuntongxun.as.common.utils.ToastUtil;
import com.yuntongxun.as.core.ECAsyncTask;
import com.yuntongxun.as.photopicker.PhotoPickerActivity;
import com.yuntongxun.as.pojo.ImUserState;
...
import com.yuntongxun.as.ui.CCPFragment;
import com.yuntongxun.as.ui.LocationActivity;
import com.yuntongxun.as.ui.LocationInfo;
import com.yuntongxun.as.ui.SDKCoreHelper;
import com.yuntongxun.as.ui.chatting.base.ECPullDownView;
import com.yuntongxun.as.ui.chatting.base.OnListViewBottomListener;
import com.yuntongxun.as.ui.chatting.base.OnListViewTopListener;
import com.yuntongxun.as.ui.chatting.base.OnRefreshAdapterDataListener;
...
import com.yuntongxun.as.ui.chatting.view.SmileyPanel;
import com.yuntongxun.as.ui.contact.AtSomeoneUI;
import com.yuntongxun.as.ui.contact.ECContacts;
import com.yuntongxun.as.ui.group.GroupInfoActivity;
import com.yuntongxun.as.ui.plugin.FileExplorerActivity;
...
/**
 * com.yuntongxun.ecdemo.ui.chatting in ECDemo_Android  聊天页面
...
public class ChattingFragment extends CCPFragment implements
	...
	public static final int REQUEST_CODE_VIDEORECORD = 0x9;
	public static final int REQUEST_CODE_SELECT_FILE = 0x2a;
	...
	/** 联系人名称 */
	public final static String CONTACT_IMG_URL = "CONTACT_IMG_URL";
    ...
    private void initActivityState(Bundle savedInstanceState) {
		...
		mImgUrl = intent.getStringExtra(CONTACT_IMG_URL);
        ...
        if(!isPeerChat()) {
            IMessageSqlManager.checkContact(mRecipients, mUsername,mImgUrl);
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SELECT_FILE || requestCode == SELECT_AT_SOMONE) {
            if (data == null) {
                return;
            }
        ...
        if(data != null && REQUEST_CODE_SELECT_FILE == requestCode) {
		...
		if (requestCode == REQUEST_CODE_VIDEORECORD) {
     ...
     * @param text
     */
    private void handleSendTextMessage(CharSequence text) {// todo
        if(text == null) {
            return ;
        }
...
//            	isFireMsg=false;//重置
    ...
    private class OnOnChattingPanelImpl implements CCPChattingFooter2.OnChattingPanelClickListener {
		...
		public void OnSelectFileRequest() {
			startActivityForResult(new Intent(getActivity(),
					FileExplorerActivity.class), REQUEST_CODE_SELECT_FILE);
			hideBottomPanel();
		}
		...
		@Override
		public void OnSelectVideoRequest() {//视频通话
			handleVideoCall();
			hideBottomPanel();
    ...
    public void onClick(View v) {
		...
		if (i == R.id.btn_left) {
			...
			if (!isPeerChat()) {
				// 如果是点对点聊天
				// todo 联系人账号mRecipients
				ToastUtil.showMessage("进入联系人详情页");
				return;
			}
			// 群组聊天室
