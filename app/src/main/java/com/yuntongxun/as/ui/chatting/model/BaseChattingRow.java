...
//                }
    ...
    public void buildChattingBaseData(Context context, BaseHolder baseHolder, ECMessage detail, int position) {
       ...
       String userRemark = ContactSqlManager.getContact(detail.getForm()).getRemark();
        ImageLoader.getInstance().displayImage(userRemark,baseHolder.getChattingAvatar());
