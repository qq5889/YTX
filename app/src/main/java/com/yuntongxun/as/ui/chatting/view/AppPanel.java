...
import com.yuntongxun.as.common.base.CCPDotView;
import com.yuntongxun.as.common.base.CCPFlipper;
...
public class AppPanel extends LinearLayout implements CCPFlipper.OnFlipperPageListener
	...
	/**
	 * width of {@link com.yuntongxun.as.ui.chatting.view.AppPanel} {@link AppGrid}
	 */
	private int mGridWidth;
	
	/**
	 * height of {@link com.yuntongxun.as.ui.chatting.view.AppPanel} {@link AppGrid}
	 */
	...
	final AppGrid.OnCapabilityItemClickListener mCapabilityItemClickListener
		= new AppGrid.OnCapabilityItemClickListener() {
			...
			public void onPanleItemClick(int index, int capabilityId , String capabilityName) {
				...
				} else if (capabilityId == R.string.app_panel_location) {
